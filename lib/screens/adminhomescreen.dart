...
import 'package:cunadelsabor/screens/menusadmin/listreservasscreen.dart';
import 'package:cunadelsabor/screens/login/login.dart';
import 'package:cunadelsabor/screens/menusadmin/adminbebidas.dart';
import 'package:cunadelsabor/screens/menusadmin/adminentradas.dart';
import 'package:cunadelsabor/screens/menusadmin/adminplatillos.dart';
import 'package:cunadelsabor/screens/menusadmin/adminpostres.dart';
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                Navigator.of(context).pop(); // Cierra el diálogo
                // Redirige a la pantalla de inicio (inicioScreen)
                        ...
                        switch (index) {
                          case 0:
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => AdminPlatillosScreen()),
                            );
                            break;
                          case 1:
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => AdminPostresScreen()),
                            );
                            break;
                          case 2:
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => AdminEntradasScreen()),
                            );
                            break;
                          case 3:
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => AdminBebidasScreen()),
                            );
                            break;
                          case 4:
                            Navigator.push(
